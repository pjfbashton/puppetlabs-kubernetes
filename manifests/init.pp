...
class kubernetes (
  ...
  Optional[String] $etcd_listen_client_urls                    = undef,
  Optional[String] $etcd_advertise_client_urls                 = undef,
  Optional[String] $etcd_listen_peer_urls                      = undef,
  Optional[String] $etcd_initial_advertise_peer_urls           = undef,
